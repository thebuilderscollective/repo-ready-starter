# Application working agreements
...
- Use the relevant PRD in docs/prds/ to keep work within the agreed scope.

For a task in app/billing/, also read app/billing/AGENTS.md.
All document paths above are relative to the repository root.
